...
class KeyToDoorEnvQuality(gym.Env):
    """
    ...
    def step(self, action):
        ...
        # If the agent has key in room 1 and is in the first step of the room, reward += 1
        if self.room == 1 and self.has_key == 1 and self.room_steps == 0:
            reward += 1
