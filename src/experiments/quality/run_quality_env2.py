...
def main():
    ...
    # ---------------------------------------------------------
    base_dir = os.getcwd()
    quality_datasets_path = os.path.join(base_dir, "results/data/quality_env2")
    dt_models_base_dir = os.path.join(base_dir, "results/models/DT/quality_env2")
    os.makedirs(quality_datasets_path, exist_ok=True)
    
    env = KeyToDoorEnvQuality(n=10, render_mode="human")
    ...
    for quality_dataset in quality_datasets:
        dt_save_path = os.path.join(dt_models_base_dir, f"quality_env2/dt_model_{quality_dataset}.d3")
        ...
        dt_config = {
            ...
            "dt": {
                ...
                "log_dir": f"logs/quality_env2/dt_{quality_dataset}"
            }
        }
    ...
    # ---------------------------------------------------------
    print("\n=== Evaluation ===")
    eval_config_path = os.path.join(base_dir, "src/experiments/quality/configs/evaluate_quality_env2.json")
